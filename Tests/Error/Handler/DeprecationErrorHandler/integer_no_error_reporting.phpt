...
passthru("php -d error_reporting=32767 " . $behat . "/vendor/bin/behat --profile=integer_no_error_reporting --out=integer_no_error_reporting.log 2>/dev/null", $exitCode);
...
User deprecated feature: 6x
    2x in Scenario: Silenced from file %s/features/normal.feature on line 7
        1x in Step: When I generate error on line 8
        1x in Step: And I generate error on line 9
    2x in Scenario: Unsilenced from file %s/features/normal_with_background_scenario.feature on line 5
        2x in Step: When I generate error on line 3
    2x in Scenario: Silenced from file %s/features/normal_with_background_scenario.feature on line 9
...
User deprecated feature silenced: 4x
    2x in Scenario: Unsilenced from file %s/features/normal.feature on line 3
...
User deprecated feature silenced: 4x
    2x in Scenario: Unsilenced from file %s/features/legacy_feature.feature on line 4
        1x in Step: When I generate silenced error on line 5
        1x in Step: And I generate silenced error on line 6
    2x in Scenario: Unsilenced from file %s/features/legacy_scenario.feature on line 4
        1x in Step: When I generate silenced error on line 5
        1x in Step: And I generate silenced error on line 6

User deprecated feature: 4x
    2x in Scenario: Silenced from file %s/features/legacy_feature.feature on line 8
        1x in Step: When I generate error on line 9
        1x in Step: And I generate error on line 10
    2x in Scenario: Silenced from file %s/features/legacy_scenario.feature on line 9
        1x in Step: When I generate error on line 10
        1x in Step: And I generate error on line 11
